...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63e4f314878601_91815856',
...
function content_63e4f314878601_91815856 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'menu' => 
  array (
    'compiled_filepath' => 'C:\\xampp\\htdocs\\mips\\var\\cache\\prod\\smarty\\compile\\etrendlite\\41\\df\\19\\41df1985130dffd7d3fe4cb369091546a0b40be7_2.module.psmainmenupsmainmenu.tpl.php',
    'uid' => '41df1985130dffd7d3fe4cb369091546a0b40be7',
    'call_name' => 'smarty_template_function_menu_41511107563e4f31485d311_50357386',
  ),
));
...
/* smarty_template_function_menu_41511107563e4f31485d311_50357386 */
if (!function_exists('smarty_template_function_menu_41511107563e4f31485d311_50357386')) {
function smarty_template_function_menu_41511107563e4f31485d311_50357386(Smarty_Internal_Template $_smarty_tpl,$params) {
...
?>
                <li class="classic-list <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['node']->value['type'], ENT_QUOTES, 'UTF-8');
if ($_smarty_tpl->tpl_vars['node']->value['current']) {?> current <?php }?> <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?> has-child <?php }?> level<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['depth']->value, ENT_QUOTES, 'UTF-8');?>
...
" data-toggle="collapse" class="navbar-toggler collapse-icons">
                    ...
                    <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>
                        <div <?php if ($_smarty_tpl->tpl_vars['depth']->value === 0) {?> class="classic-menu popover sub-menu js-sub-menu collapse"<?php } else { ?> class="collapse"<?php }?> id="top_sub_menu_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['_expand_id']->value, ENT_QUOTES, 'UTF-8');?>
">
                            ...
                            <?php if (count($_smarty_tpl->tpl_vars['node']->value['image_urls']) > 0) {?>
                                <div class="cat-bottom-block" data-count="<?php echo htmlspecialchars((string) count($_smarty_tpl->tpl_vars['node']->value['children']), ENT_QUOTES, 'UTF-8');?>
">
                                    <?php
...
" alt="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['node']->value['label'], ENT_QUOTES, 'UTF-8');?>
">
                                        </p>
                                    <?php
}
